...
public partial class @MyInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""id"": ""a5aaa061-4afc-48be-834a-ef93957aee25"",
            ""actions"": [
                {
                    ""name"": ""TriggerButton"",
                    ""type"": ""Button"",
                    ""id"": ""0cb59046-ff5d-48da-926a-e522e2ad6dc7"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""8d262c2a-8468-472d-ae5b-76b0be90e99f"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0e0fa9c2-d6ba-4ee7-96fa-8ba80eb61a7e"",
    ...
    ~@MyInputActions()
    {
        UnityEngine.Debug.Assert(!m_ControllerInputs.enabled, "This will cause a leak and performance issues, MyInputActions.ControllerInputs.Disable() has not been called.");
    }
    ...
    /// <summary>
    /// Provides access to input actions defined in input action map "ControllerInputs".
    /// </summary>
    public struct ControllerInputsActions
    {
        ...
        /// </summary>
        public ControllerInputsActions(@MyInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "ControllerInputs/TriggerButton".
        /// </summary>
        ...
        /// <summary>
        /// Implicitly converts an <see ref="ControllerInputsActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// </remarks>
        /// <seealso cref="ControllerInputsActions" />
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="ControllerInputsActions.UnregisterCallbacks(IControllerInputsActions)" />.
        /// </summary>
        /// <seealso cref="ControllerInputsActions.UnregisterCallbacks(IControllerInputsActions)" />
        ...
        /// </remarks>
        /// <seealso cref="ControllerInputsActions.AddCallbacks(IControllerInputsActions)" />
        /// <seealso cref="ControllerInputsActions.RemoveCallbacks(IControllerInputsActions)" />
        /// <seealso cref="ControllerInputsActions.UnregisterCallbacks(IControllerInputsActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="ControllerInputsActions" /> instance referencing this action map.
    /// </summary>
    public ControllerInputsActions @ControllerInputs => new ControllerInputsActions(this);
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "ControllerInputs" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="ControllerInputsActions.AddCallbacks(IControllerInputsActions)" />
    /// <seealso cref="ControllerInputsActions.RemoveCallbacks(IControllerInputsActions)" />
